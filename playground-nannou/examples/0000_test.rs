...
fn main() {
    ...
    // 最大最小を取って合成
    {
        ...
        println!("{:?}", vec2(1.0, 2.0).max(vec2(3.0, 1.0))); // => Vec2(3.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).min(vec2(3.0, 1.0))); // => Vec2(1.0, 1.0)
    }
    ...
    // 成分の入れ替え
    {
        println!("{:?}", vec2(1.0, 2.0).xy()); // => Vec2(1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yx()); // => Vec2(2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xx()); // => Vec2(1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yy()); // => Vec2(2.0, 2.0)

        println!("{:?}", vec2(1.0, 2.0).xxx()); // => Vec3(1.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xxy()); // => Vec3(1.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).xyx()); // => Vec3(1.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xyy()); // => Vec3(1.0, 2.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yxx()); // => Vec3(2.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yxy()); // => Vec3(2.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yyx()); // => Vec3(2.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yyy()); // => Vec3(2.0, 2.0, 2.0)

        println!("{:?}", vec2(1.0, 2.0).xxxx()); // => Vec4(1.0, 1.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xxxy()); // => Vec4(1.0, 1.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).xxyx()); // => Vec4(1.0, 1.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xxyy()); // => Vec4(1.0, 1.0, 2.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).xyxx()); // => Vec4(1.0, 2.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xyxy()); // => Vec4(1.0, 2.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).xyyx()); // => Vec4(1.0, 2.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).xyyy()); // => Vec4(1.0, 2.0, 2.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yxxx()); // => Vec4(2.0, 1.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yxxy()); // => Vec4(2.0, 1.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yxyx()); // => Vec4(2.0, 1.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yxyy()); // => Vec4(2.0, 1.0, 2.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yyxx()); // => Vec4(2.0, 2.0, 1.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yyxy()); // => Vec4(2.0, 2.0, 1.0, 2.0)
        println!("{:?}", vec2(1.0, 2.0).yyyx()); // => Vec4(2.0, 2.0, 2.0, 1.0)
        println!("{:?}", vec2(1.0, 2.0).yyyy()); // => Vec4(2.0, 2.0, 2.0, 2.0)
    }
    ...
    // 3次元SIMD対応版
    {
        println!("{:?}", Vec3A::new(2.0, 3.0, 4.0));             // => Vec3A(2.0, 3.0, 4.0)
        println!("{:?}", Vec3A::new(2.0, 3.0, 4.0).truncate());  // => Vec2(2.0, 3.0)
    }
}
