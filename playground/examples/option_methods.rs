fn main() {
    ...
    println!("still can print text: {:?}", text); // => Some("foo")
    ...
    let mut x = Some(1);
    let r: &mut u32 = x.get_or_insert(2);
    println!("{:?}", r);        // => 1
    *r = 3;
    println!("{:?}", x);        // => Some(3)
    ...
    let mut x = Some(1);
    let r: &mut u32 = x.get_or_insert_with(||2);
    println!("{:?}", r);        // => 1
    *r = 3;
    println!("{:?}", x);        // => Some(3)
    ...
    println!("{:?}", Some(1).zip(Some(2))); // => Some(2)
    ...
    println!("{:?}", Some(Some(1)).flatten());       // => Some(Ok(1))
